...
var Zuck = function(t) {
                    ...
                    h = function() {
                        ...
                        var g = a("#zuck-modal-content"),
                            ...
                            I = function(t, e, n) {
                                ...
                                S.className = "story-viewer muted ".concat(e, " ").concat(n ? "" : "stopped", " ").concat(u("backButton") ? "with-back-button" : ""), S.setAttribute("data-story-id", f), S.querySelector(".slides-pointers .wrap1").innerHTML = v, o(S.querySelectorAll(".close1, .back"), (function(t, e) {
       ...
       $.ajax({
         ...
         enctype: 'multipart/form-data',
           ...
           error: function(story) {
                            ...
                            close:function()
                  {
                     var t=a("#zuck-modal"); u("callbacks", "onClose")(d.internalData.currentStory, (function()
                           {
                    ...
                    b = function(t, e) {
                        ...
                        try {
                        	console.log(d.data[n-1])
                        	if (d.data[n-1]!= undefined){
                        		if (d.data[n-1].seenp=="seen"){
                        			var k = "seen"
                        		}
                        		else{
                        			var k = "noseen"
                            ...
                            d.data[n] || (d.data[n] = {}), d.data[n].id = n, d.data[n].photo = t.getAttribute("data-photo"), d.data[n].name = t.querySelector(".name").innerText, d.data[n].link = t.querySelector(".item-link").getAttribute("href"), d.data[n].lastUpdated = t.getAttribute("data-last-updated"), d.data[n].seen = a,d.data[n].seenp = k, d.data[n].items || (d.data[n].items = [], d.data[n].noItems = !0)
                        } catch (t) {
                            d.data[n] = {
                                items: []
                            }
                    ...
                    w = function() {
                        o(document.querySelectorAll("#".concat(y, " .story.seenseen")), (function(t, e) {
 ...
 /*aaa*/                       var f = document.createElement("div");
                        f.innerHTML = u("template", "timelineItem")(e), c = f.firstElementChild
                    }!1 === e.seen && (d.internalData.seenItems[r] = !1, E("seenItems", d.internalData.seenItems)), c.setAttribute("data-id", r), c.setAttribute("dat-id", e.pk), c.setAttribute("data-photo", i(e, "photo")), c.setAttribute("data-last-updated", i(e, "lastUpdated")), b(c), s || u("reactive") || (n ? t.appendChild(c) : l(t, c)), o(m, (function(t, e) {
                        d.addItem(r, e, n)
                    })), n || w()
                }, d.next = function() {
                    h.next()
        ...
        return d.buildTimelineItem = function(t, e, n, a, i, c, seenp, pk) {
