...
$(function () {
    AppConfig = {
        init: function () {
             AppConfig.initSlickCarousel(), AppConfig.buttonClickEvents(),AppConfig.initAppScrollbars(), AppConfig.search(), AppConfig.materialTab(), AppConfig.initCountdown(),AppConfig.addFavorite()
        }, initTheme: function () {
            $("body").themeSettings()
